var Texture = /** @class */ (function () {
    function Texture(gl, id, target) {
        this.gl = gl;
        this.id = id;
        this.sharingCounter = 0;
        this._isDestroyed = false;
        var texture = gl.createTexture();
        if (!texture)
            throw Error("[FlatLand] Unable to create texture \"" + id + "\"!");
     ...
     */
    Texture.prototype.share = function () {
        this.sharingCounter++;
    };
    /**
     ...
     */
    Texture.prototype.attachToUnit = function (unitIndex) {
        var _a = this, gl = _a.gl, texture = _a.texture, target = _a.target, units = _a.units;
        if (unitIndex < 0)
            throw Error("[FlatLand.Texture.attachToUnit] unitIndex must be positive!");
        if (unitIndex > units.length - 1)
            throw Error("[FlatLand.Texture.attachToUnit] unitIndex must be lower than " + units.length + "!");
