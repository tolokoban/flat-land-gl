...
var SpritesPainter = /** @class */ (function (_super) {
    ...
    SpritesPainter.prototype.createQuad = function (params) {
        var data = new Float32Array(CHUNK);
        var sprite = new Quad("" + globalID++, data, this._update, this._destroy, __assign({ xTL: 0, yTL: 0, zTL: 0, uTL: 0, vTL: 0, xTR: 1024, yTR: 0, zTR: 0, uTR: 1, vTR: 0, xBR: 1024, yBR: 0, zBR: 0, uBR: 1, vBR: 1, xBL: 0, yBL: 0, zBL: 0, uBL: 0, vBL: 1 }, params));
        sprite.update();
        return sprite;
    };
    /**
