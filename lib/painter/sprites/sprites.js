...
var SpritesPainter = /** @class */ (function (_super) {
    ...
    Object.defineProperty(SpritesPainter.prototype, "texture", {
        get: function () {
    ...
    SpritesPainter.prototype.createSprite = function (params) {
        ...
        var width = texture.width || DEFAULT_WIDTH;
        var height = texture.height || DEFAULT_HEIGHT;
    ...
    SpritesPainter.prototype.render = function (time, delta) {
        var _a = this, scene = _a.scene, _prg = _a._prg, texture = _a.texture, _buffVert = _a._buffVert, _buffElem = _a._buffElem, _camera = _a._camera;
