...
var SpritesPainter = /** @class */ (function (_super) {
    ...
    SpritesPainter.prototype._update = function (sprite, data) {
        if (!this.scene) {
            // If this painter has not yet been initialized, then update has to be defered.
            this._deferedSpritesUpdate.set(sprite.id, [sprite, data]);
            return;
        }
        if (sprite.$index < 0) {
     ...
     * Only called by an instance os Sprite.
     */
    SpritesPainter.prototype._destroy = function (sprite) {
        var lastSprite = this._sprites.pop();
        if (!lastSprite) {
